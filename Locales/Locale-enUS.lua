...
L["Skits.options.event_npc_interact.title"] = "Show Quest Interations"
L["Skits.options.event_npc_interact.desc"] = "Toggle to display NPC messages when interactng throu a quest frame."
