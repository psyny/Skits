...
L["Skits.options.style_warcraft_speaker_face_animated.title"] = "Animated Speaker Portrait"
L["Skits.options.style_warcraft_speaker_face_animated.desc"] = "Set if the speakr portrait should be animated or not."
...
L["Skits.options.quest_frame_model_size.desc"] = "Set the size of the quest model frame."
L["Skits.options.quest_frame_model_offsetx.title"] = "Quest Model X Offset"
L["Skits.options.quest_frame_model_offsetx.desc"] = "Horizontal offset for the quest model frame position."
L["Skits.options.quest_frame_model_offsety.title"] = "Quest Model Y Offset"
L["Skits.options.quest_frame_model_offsety.desc"] = "Vertical offset for the quest model frame position."
L["Skits.options.quest_frame_model_animated.title"] = "Animated Quest Model"
L["Skits.options.quest_frame_model_animated.desc"] = "Toggle to enable animations for the quest model frame."
L["Skits.options.quest_frame_model_poser.title"] = "Quest Model Poser"
L["Skits.options.quest_frame_model_poser.desc"] = "Pause the animation on a pose after a random short time."
L["Skits.options.quest_frame_model_bg.title"] = "Quest Model Background"
L["Skits.options.quest_frame_model_bg.desc"] = "Select the background texture for the quest model frame."
L["Skits.options.quest_frame_model_border.title"] = "Quest Model Border"
L["Skits.options.quest_frame_model_border.desc"] = "Select the border texture for the quest model frame."
